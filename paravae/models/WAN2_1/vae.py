...
class WanVAE_(nn.Module):
    ...
    def enable_approximate_patch(self) -> None:
        self.use_approximate_patch = True
    
    def disable_approximate_patch(self) -> None:
        self.use_approximate_patch = False
    ...
    def decode(self, z, scale=None):
        ...
        if self.use_approximate_patch:
            decoded = gather_forward_split_backward(None, decoded, 3)
            
        return decoded
    
    def _decode(self, z, scale=None):
...
def _video_vae(pretrained_path=None, z_dim=16, device='cpu', **kwargs):
    """
